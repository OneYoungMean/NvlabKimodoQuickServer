...
if not defined KIMODO_TEST_RUN1_WAIT_TIMEOUT_SEC set "KIMODO_TEST_RUN1_WAIT_TIMEOUT_SEC=1800"
if not defined KIMODO_TEST_RUN2_WAIT_TIMEOUT_SEC set "KIMODO_TEST_RUN2_WAIT_TIMEOUT_SEC=1800"
